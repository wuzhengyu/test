  ...
  <body>
		...
		<div class="row-fluid">
				<ul class="nav nav-tabs">
					<li class="active"><a href="javascript:void(0)"><font style="color:#A59999">资源编辑</font>
					</a></li>
				</ul>
				<form class="form-horizontal" action="${ctx}/menu/update" id="editForm">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="menuSort" name="menuSort" value="${menu.menuSort}"/>
						</div>
					</div>
				 ...
				 <div class="form-group">
						...
						<div class="col-sm-10">
							<textarea type="text" class="form-control" id="description" name="description" >${menu.description}</textarea>
						</div>
					</div>
