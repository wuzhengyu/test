...
public class FileUtil {
		 ...
		 * @return
		 */
		public static String getNoPointExtension(String fileName) {
			String ext = StringUtils.substring(fileName,StringUtils.lastIndexOf(fileName, DOT)+1,fileName.length());
			return StringUtils.trimToEmpty(ext);
		}
